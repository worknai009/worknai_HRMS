      ...
      <div className="footer-container">
        ...
        <div className="footer-brand">
          ...
          <div className="social-links">
            <a href="https://www.linkedin.com/company/worknai-technologies-india-pvt-ltd-pune/" target="_blank" rel="noreferrer"><FaLinkedin /></a>
            <a href="https://www.instagram.com/worknai_institute_center?igsh=MW5zOXZwY3o3anVjNw==" target="_blank" rel="noreferrer"><FaInstagram /></a>
          </div>
        </div>
        ...
        <div className="footer-contact">
          ...
          <p><FaEnvelope /> worknai009@gmail.com</p>
        </div>
      </div>
