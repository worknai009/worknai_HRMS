  ...
  return (
    <div className="leave-page">
      <header className="page-head">
        <h2>
          <FaPlaneDeparture /> Leave & WFH Center
        </h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grp">
              ...
              <textarea
                ...
                placeholder={
                  form.leaveType === "WFH"
                    ? "e.g. Internet issue at office, urgent home task..."
                    : "e.g. Family function, Feeling unwell..."
                }
              />
            </div>
              ...
              leaves.map((l) => (
                <div key={l._id} className="leave-item">
                  <div className="l-icon">
                    {l.leaveType === "WFH" ? (
                      <FaLaptopHouse className="icon-wfh" />
                    ) : (
                      <FaPlaneDeparture className="icon-leave" />
                    )}
                  </div>
      ...
      <style>{`
        ...
        .page-head h2 { color: #064e3b; margin: 0; display: flex; gap: 10px; align-items: center; font-size: 1.8rem; }
        ...
        .card h3 { margin-top: 0; color: #1f2937; border-bottom: 1px solid #f3f4f6; padding-bottom: 15px; margin-bottom: 20px; font-size: 1.2rem; }
        ...
        select, input, textarea { width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; outline: none; box-sizing: border-box; font-family: inherit; font-size: 1rem; }
        select:focus, input:focus, textarea:focus { border-color: #10b981; border-width: 2px; }

        .btn-submit { width: 100%; background: #10b981; color: white; border: none; padding: 14px; border-radius: 10px; font-weight: 700; cursor: pointer; transition: 0.2s; margin-top: 10px; font-size: 1rem; }
        ...
        .l-icon { font-size: 1.5rem; padding: 10px; background: white; border-radius: 50%; box-shadow: 0 2px 5px rgba(0,0,0,0.05); flex-shrink: 0; }
        .icon-wfh { color: #8b5cf6; }
        .icon-leave { color: #10b981; }
        
        .l-details { flex: 1; }
        .l-top { display: flex; justify-content: space-between; margin-bottom: 4px; flex-wrap: wrap; gap: 5px; }
